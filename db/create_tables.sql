...
CREATE TABLE address (
    ...
    state enum('Andhra Pradesh','Arunachal Pradesh','Assam','Bihar','Chhattisgarh','Goa','Gujarat','Haryana','Himachal Pradesh','Jharkhand','Karnataka','Kerala','Madhya Pradesh','Maharashtra','Manipur','Meghalaya','Mizoram','Nagaland','Odisha','Punjab','Rajasthan','Sikkim','Tamil Nadu','Tripura','Uttarakhand','Uttar Pradesh','West Bengal') DEFAULT NULL,
...
CREATE TABLE shipment (
    ...
    CONSTRAINT shipment_ibfk_2 FOREIGN KEY (user_id) REFERENCES customer (Login_id)
);
...
CREATE TABLE rating (
    ...
    CONSTRAINT rating_ibfk_2 FOREIGN KEY (Ratee_id) REFERENCES book (ISBN)
);
